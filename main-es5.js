...
var ArtistaComponent = /** @class */ (function () {
    ...
    ArtistaComponent.prototype.getArtist = function (id) {
        var _this = this;
        this.loading = true;
    ...
    ArtistaComponent.prototype.getTopTracks = function (id) {
        ...
        this.spotify.getTopTracks(id)
            .subscribe(function (resp) {
            console.log(resp);
            _this.toptracks = resp;
        });
    };
    ArtistaComponent.ctorParameters = function () { return [
...
var TarjetasComponent = /** @class */ (function () {
    ...
    TarjetasComponent.ctorParameters = function () { return [
...
var DomseguroPipe = /** @class */ (function () {
    ...
    DomseguroPipe.ctorParameters = function () { return [
...
var SpotifyService = /** @class */ (function () {
    ...
    SpotifyService.prototype.getNewReleases = function () {
        return this.getQuery('browse/new-releases?limit=20')
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (resp) { return resp['albums'].items; }));
    };
    SpotifyService.prototype.getArtista = function (termino) {
        return this.getQuery("search?q=" + termino + "&type=artist&limit=15")
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (resp) { return resp['artists'].items; }));
    };
    ...
    SpotifyService.prototype.getTopTracks = function (id) {
        return this.getQuery("artists/" + id + "/top-tracks?country=us")
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (resp) { return resp['tracks']; }));
    };
